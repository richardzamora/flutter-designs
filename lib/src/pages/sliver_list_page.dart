      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            "New",
            style: TextStyle(
                color: appTheme.darkTheme ? Colors.blueGrey : Color(0xff532128),
                fontSize: 50),
          ),
        ),
        Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                width: 150,
                height: 8,
                color: appTheme.darkTheme ? Colors.blueGrey : Color(0xffF7CDD5),
              ),
            ),
            Container(
              alignment: Alignment.centerLeft,
...
class _ListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final appTheme = Provider.of<ThemeChanger>(context);
    // appTheme.darkTheme ? Colors.grey :
    return Container(
      alignment: Alignment.centerLeft,
      ...
      decoration: BoxDecoration(
          color: appTheme.darkTheme ? Colors.blueGrey : this.color,
